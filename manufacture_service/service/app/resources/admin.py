...
_.add_argument('manufacture_pid', type=str, required=True, help='Manufactures pid')
...
class Admin(Resource):
    ...
    def post(self):
        ...
        if not match(self._regex['pid'], (manufacture_pid := args['manufacture_pid'].strip())):
            errors['manufacture_pid'] = f"Did not match {self._regex['pid']}"
